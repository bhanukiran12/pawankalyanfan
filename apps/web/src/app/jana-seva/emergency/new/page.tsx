...
export default function NewEmergencyHelpPage() {
  const router = useRouter();
  const [defaultCategory, setDefaultCategory] = useState("URGENT_ASSISTANCE");
    ...
    <PageShell background="form" overlay="dark">
      <div className="container-page py-8 sm:py-12 max-w-lg">
        ...
        <FadeIn className="mt-4">
          <PageHeading title="Post Help Request" subtitle="Emergency & urgent community assistance." />
        </FadeIn>
