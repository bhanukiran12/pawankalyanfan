...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "hero-gradient":
          "linear-gradient(135deg, rgba(10,10,10,0.95) 0%, rgba(153,27,27,0.4) 50%, rgba(10,10,10,0.98) 100%)",
        "card-gradient":
          "linear-gradient(180deg, rgba(23,23,23,0.8) 0%, rgba(10,10,10,0.95) 100%)",
        "red-glow":
